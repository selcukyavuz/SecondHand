...
using SecondHandGear.Web.Settings;
...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> ExchangeToken(string code,string scope)
    {
        ...
        TokenExchange? tokenExchangeResponse = JsonSerializer.Deserialize<TokenExchange>(response.Content!,SecondHandGearWebJsonSerializerSettings.Settings);
