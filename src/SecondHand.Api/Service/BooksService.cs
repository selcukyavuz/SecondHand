...
public class BooksService
{
    ...
    public BooksService(IOptions<SecondHandDatabaseSettings> secondHandDatabaseSettings)
    {
        ...
        _booksCollection = mongoDatabase.GetCollection<Book>(secondHandDatabaseSettings.Value.BooksCollectionName);
    }
